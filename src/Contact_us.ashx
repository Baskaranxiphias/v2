...
public class Contact_us : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        try
        {
            ...
            string SubjectReply = "Thank You " + username + " For Contacting Atsi";

            StringBuilder MessageAdmin = MessageForAdmin(username, Email,Comments);
            StringBuilder MessageReply = MessageForUser(username);
    ...
    public StringBuilder MessageForAdmin(string Name, string Email, string comments)
    {
        ...
        sb.Append("Message from ATSI Website");
        sb.Append("</td>");
        sb.Append("</tr>");
        sb.Append("<tr style='font-family: Helvetica Neue, Helvetica, Helvetica, Arial, sans-serif; box-sizing: border-box; font-size: 14px; margin: 0; padding: 0;'>");
        ...
        sb.Append("<tr style='font-family: Helvetica Neue, Helvetica, Helvetica, Arial, sans-serif; box-sizing: border-box; font-size: 14px; margin: 0; padding: 0;'>");
        sb.Append("<td class='content-block' style='font-family: Helvetica Neue, Helvetica, Helvetica, Arial, sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;' valign='top'>");
        sb.Append("<strong style='font-family: Helvetica Neue, Helvetica, Helvetica, Arial, sans-serif; box-sizing: border-box; font-size: 14px; margin: 0; padding: 0;'>Name : </strong> " + Name + "<br />");
        ...
        sb.Append("<strong style='font-family: Helvetica Neue, Helvetica, Helvetica, Arial, sans-serif; box-sizing: border-box; font-size: 14px; margin: 0; padding: 0;'>Comments : </strong> " + comments + "");
        sb.Append("</td>");
        sb.Append("</tr>");
