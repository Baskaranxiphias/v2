...
export const routes: Routes = [
    ...
    { path: 'school-management-ERP-software', component: ErpSoftwareComponent, },
    { path: 'online-payroll-management-system-software', component: PayrollManagementComponent, },
    { path: 'online-library-management-software', component: LibraryComponent, },
    ...
    { path: 'human-resource-management-software', component: HrmsComponent, },
    { path: 'school-information-management-system', component: SchoolComponent, },
    { path: 'school-timetable-generator-system-software', component: TimeTableComponent, },
    { path: 'hostel-management-system-software', component: HostelComponent, },
